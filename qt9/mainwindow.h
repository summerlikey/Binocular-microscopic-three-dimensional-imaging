...
public:
    ...
    void SetLeftCameraId(QString id);//设置左边相机Id;目前左边相机DEV_000F315BA9A2
    void SetRightCameraId(QString id);//设置右边相机Id;目前右边相机DEV_000F315BA9A3
    QString GetLeftCameraId();//获取左边相机Id;目前左边相机DEV_000F315BA9A2
    QString GetRightCameraId();//获取右边相机Id;目前右边相机DEV_000F315BA9A3
    void SetLeftCameraStatusLight();//设置左状态灯
    void SetRightCameraStatusLight();//设置右状态灯
