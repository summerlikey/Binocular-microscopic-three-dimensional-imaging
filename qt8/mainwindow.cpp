...
QString MainWindow::GetLeftCameraId()//获取左边相机Id
{
    QString str="";
    QString res="";
    std::string leftcameraid="DEV_000F315BA9A2";
    str=QString::fromStdString(leftcameraid);
...
QString MainWindow::GetRightCameraId()//获取右边相机Id
{
    QString str="";
    QString res="";
    std::string rightcameraid="DEV_000F315BA9A3";
    str=QString::fromStdString(rightcameraid);
    for(std::vector<std::string>::iterator it=m_cameras.begin();it!=m_cameras.end();it++)
    {
