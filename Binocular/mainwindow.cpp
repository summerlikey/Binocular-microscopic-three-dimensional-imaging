...
VmbErrorType MainWindow::CopyToImage( VmbUchar_t *pInBuffer, VmbPixelFormat_t ePixelFormat, VmbUint32_t nHeight, VmbUint32_t nWidth, QImage &pOutImage, const float *Matrix /*= NULL */ )
{
